...
public class OlympicYear {
    public static void main(String[] args){
        ...
        // 出力結果：
        // 2019年は、オリンピックが、開催されません。
        // 2020年は、夏季オリンピックが、開催されます。
        // 2022年は、冬季オリンピックが、開催されます。
        ...
        if(year % 4 == 0){
            System.out.println(year + "年は、夏季オリンピックが、開催されます。");
        }else if(year % 4 == 2){
        ...
        if(year % 4 == 0) {
            ...
            System.out.println(year + "年は、冬季オリンピックが、開催されます。");
        }else{
            System.out.println(year + "年は、オリンピックが開催されません。");
        }
